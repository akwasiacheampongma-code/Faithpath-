...
Storage: `faithpath.v1.rebuild` (Hauptdaten), `faithpath.guidedPlans.v1` (Planfortschritt), bisher `faithpath.onboarding.v3`. V4 behält die ersten beiden unverändert und migriert das Hauptobjekt additive auf Schema-Version 2.
